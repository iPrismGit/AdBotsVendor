...
class ProfileDetailsViewModel @Inject constructor(
    ...
    private val _profileResponse = MutableStateFlow<UiState<ProfileApiResponse>>(UiState.Idle)
    val profileResponse: StateFlow<UiState<ProfileApiResponse>> = _profileResponse
