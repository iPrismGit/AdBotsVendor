...
@HiltViewModel
class ContentPagesViewModel @Inject constructor(private val repository: SettingsRepository) : ViewModel() {

    private val _response = MutableStateFlow<UiState<ContentPagesApiResponse>>(UiState.Idle)
    val response: StateFlow<UiState<ContentPagesApiResponse>> = _response

    fun register(request: ContentPagesRequest) {
